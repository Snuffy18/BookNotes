...
export function BookAddedToast({ showCount }: Props) {
  ...
  return (
    <View pointerEvents="none" style={styles.overlayRoot}>
      ...
      >
        <View style={[styles.pill, pillSurface]} accessibilityRole="text" accessibilityLabel="Book added">
          <Ionicons name="checkmark-circle" size={18} color={SUCCESS_GREEN} />
          <Text style={[styles.label, { color: titleColor }]}>Book Added</Text>
        </View>
      </Animated.View>
    </View>
  );
